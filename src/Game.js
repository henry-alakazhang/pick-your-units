...
const fe5 = {
  ...
  characters: {
    ...
    Eyrios: { class: "Mage Knight", exclude: ["Olwen"] },
    ...
    Sara: { class: "Sister" },
    Shanam: { class: "Swordmaster", exclude: ["Sleuf", "Misha", "Amalda"] },
    Miranda: { class: "Mage", exclude: ["Sleuf", "Misha", "Amalda"] },
    Xavier: { class: "General" },
    Amalda: {
      class: "Paladin (F)",
      exclude: ["Miranda", "Shanam", "Conomore"],
    },
    Conomore: { class: "Paladin (M)", exclude: ["Sleuf", "Misha", "Amalda"] },
