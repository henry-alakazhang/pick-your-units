...
const fe5 = {
  ...
  characters: {
    ...
    Eyrios: { class: "Mage Knight", exclude: ["Olwen", "Miranda", "Shanam", "Conomore"] },
    ...
    Sara: { class: "Sister" },
    Shanam: { class: "Swordmaster", exclude: ["Sleuf", "Misha", "Amalda", "Eyrios"] },
    ...
    Conomore: { class: "Paladin (M)", exclude: ["Sleuf", "Misha", "Amalda", "Eyrios"] },
